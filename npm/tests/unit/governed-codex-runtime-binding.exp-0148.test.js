...
function governedAgent(root) {
  return new ProbeAgent({ provider: 'codex', path: root, cwd: root, allowedTools: [...TOOLS], requestTimeout: 600000, governedCodexProfile: profile(root), disableMermaidValidation: true });
}
...
agent.answerGoverned('x', { schema, resultIdentity: 'probe.governed-result-identity/v1' });`;
  ...
  await t.test('EXP-0152 T15 frozen files and legacy function/declaration regions remain exact', async () => {
    ...
    assert.equal(sha(await read('../../src/agent/engines/codex.js')), 'f74fa844f4c87933891b73995d0181262c6a3b0beaabcc23f20a3f20ac96d536'); assert.equal(sha(await read('../../src/agent/schemaUtils.js')), '24332877e019ef29311f03ce9b63e61925c25fd7f83f5dd442b22dc68c60f6e9'); assert.equal(sha(await read('../../src/agent/engines/governed-codex-profile.js')), 'c3c1829c3571512b86a623b9215dd4704c8de8d3ee4d1a1b4d3a56fe20ac8f4f');
