...
agent.answerGoverned('x', { schema, resultIdentity: 'probe.governed-result-identity/v1' });`;
  ...
  await t.test('EXP-0152 T15 frozen files and legacy function/declaration regions remain exact', async () => {
    ...
    assert.equal(sha(await read('../../src/agent/engines/codex.js')), '330ef334494f60226641bcf7069435611977feb4c4af2e2854ef4c879db396c5'); assert.equal(sha(await read('../../src/agent/schemaUtils.js')), '24332877e019ef29311f03ce9b63e61925c25fd7f83f5dd442b22dc68c60f6e9'); assert.equal(sha(await read('../../src/agent/engines/governed-codex-profile.js')), 'e191e514503f40682a405a6de19bdcda6e36f8e4a8d74e6cda13be40ea9b917e');
