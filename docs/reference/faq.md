...
Probe supports 15+ languages including Rust, JavaScript, TypeScript, Python, Go, C, C++, Java, Ruby, PHP, Swift, Solidity, Bash, QML, C#, HTML, Markdown, and YAML. See [Supported Languages](../supported-languages.md).
