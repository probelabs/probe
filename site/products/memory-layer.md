...
/* Vision Section */
.section-vision { background: var(--c-bg-subtle); }
...
/* Sources Section */
.section-sources { background: var(--c-bg); }
.sources-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: var(--space-lg); }
...
.source-card:hover { border-color: var(--c-border-hover); transform: translateY(-2px); }
...
.source-icon svg { width: 24px; height: 24px; color: var(--c-primary-light); }
.source-card h3 { font-size: 1rem; font-weight: 600; margin: 0 0 var(--space-xs); color: var(--c-text); }
.source-card p { font-size: 0.875rem; color: var(--c-text-muted); margin: 0; }

/* CTA Section */
.section-cta { background: var(--c-bg-subtle); padding: var(--space-4xl) 0; }
...
@media (max-width: 1024px) {
  ...
  .vision-card { grid-template-columns: 1fr; text-align: center; }
  .vision-content { text-align: left; }
}
...
@media (max-width: 768px) {
  ...
  .solution-grid, .sources-grid { grid-template-columns: 1fr; }
  .section { padding: var(--space-3xl) 0; }
  .container { padding: 0 var(--space-md); }
  .cta-card, .vision-card { padding: var(--space-xl); }
  .vision-number { font-size: 3rem; }
}
...
html:not(.dark) .card-icon, html:not(.dark) .source-icon { background: linear-gradient(135deg, rgba(124, 58, 237, 0.08) 0%, rgba(6, 182, 212, 0.08) 100%); border-color: rgba(124, 58, 237, 0.15); }
...
html:not(.dark) .cta-badge { background: rgba(6, 182, 212, 0.08); border-color: rgba(6, 182, 212, 0.15); }
html:not(.dark) .vision-card { background: var(--c-bg-muted); }
</style>
